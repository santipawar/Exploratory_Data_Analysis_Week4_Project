...
png('D:/Users/santi_000/Desktop/Coursera/Exploratory Data Analysis/Week-4/exdata_data_NEI_data/plot6.png')

ggplot(data=DF, aes(x=year, y=Emissions)) + geom_bar(stat="identity",fill="grey",width=0.75)  + 
